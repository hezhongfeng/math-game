...
- 🔢 **数字探索**：输入数字（1~1000），直观看到小球阵列，理解十进制概念
...
| 数字探索 | ✅ 已实现 | 1~1000 小球阵列可视化，3D可旋转立方体 |
| 语音播报 | 🚧 规划中 | 当前版本未开放入口 |
...
│   │   ├── Game.vue              # 游戏页（含反馈动画）
│   │   ├── Home.vue              # 主页
│   │   └── NumberExplore.vue     # 数字探索页（输入+可视化展示）
│   ├── utils/               # 工具函数
│   │   └── generator.js          # 题目生成器
