...
- 🎮 **渐进式学习**：20 个难度等级循序渐进，按儿童计算策略平滑推进
...
- 在第 8、12 关加入“拆分”训练，帮助孩子建立 `3 = 1 + 2` 这类关系理解
- 组合 / 拆分类题目优先提示“还差几”“谁和谁是好朋友”，不把减法当作第一提示
- 第 8、12 关提供空位可视化提示，让孩子先看见“还差几个”
- 在第 9、15、17、18 关额外做了“过渡缓冲”，避免突然出现跨度太大的题
...
- **鼓励语音**：当前版本已启用简短鼓励语音，依赖浏览器语音合成能力
