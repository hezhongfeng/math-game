...
| 鼓励语音 | ✅ 已实现 | 结算后播放浏览器语音合成主反馈，每轮只播一句 |
...
- **语音离线策略**：鼓励语音使用浏览器/系统内置 SpeechSynthesis，不请求云端语音服务；iOS 会在首次触摸时静音预热
...
- 第 8、9、13、14 关提供空位可视化，让孩子先看见缺了几个位置
- 小球提示支持在做题页关闭，并会记住选择，方便熟练后练习
...
| `math-game-number-bond-hint-enabled` | String | 是否显示拆分小球提示，默认显示 |
...
- **鼓励语音**：当前版本已启用结算主反馈语音，依赖浏览器语音合成能力和设备本地语音包，不联网合成
