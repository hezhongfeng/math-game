...
| [docs/DIFFICULTY_CURVE.md](./docs/DIFFICULTY_CURVE.md) | 查看 26 关难度曲线、典型题型与边界 |
...
- 🎮 **渐进式学习**：26 个难度等级循序渐进，按儿童计算策略平滑推进
...
| 功能 | 描述 |
|------|------|
| **26个难度等级** | 按“数感 → 组合 → 拆分 → 凑十 → 过十/退位 → 关系理解 → 阶段综合”设计完整学习曲线 |
...
| 能力 | 状态 | 说明 |
|------|------|------|
| 关卡训练（26关） | ✅ 已实现 | 按儿童策略能力逐级解锁，并在 10 以内与 20 以内各增加综合收口 |
...
│   └── DIFFICULTY_CURVE.md       # 难度曲线说明
├── scripts/                 # 工具脚本
│   └── generate-icons.js         # PWA 图标生成
├── tests/
│   ├── unit/                # Vitest 单元测试
...
- 在第 8、13、20、22 关额外做了“过渡缓冲”，避免突然出现跨度太大的题
